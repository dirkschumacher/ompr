...
p + ggtitle("Warehouse location problem", 
          "Black dots are customers. Light tred triangles represent potential warehouse locations.")
```
...
p + 
  ...
  ggtitle(paste0("Cost optimal warehouse locations and customer assignment"),
          "Big red triangles are warehouses built, light red unused warehouses. 
